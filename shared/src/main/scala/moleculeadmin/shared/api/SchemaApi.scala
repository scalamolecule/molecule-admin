...
trait SchemaApi extends BaseApi {
  ...
  def updateDescrAttr(db: String, part: String, ns: String, attr: String, descrAttr: Option[String]): FlatSchema = ???
  ...
  def updatePartition(schema: MetaSchema, db: String, curPart: String, newPart: String,
                      descr: Option[String] = None, pos0: Int = 0
                     ): Either[String, MetaSchema] = ???

  def deletePartition(schema: MetaSchema, db: String, part: String
                     ): Either[String, MetaSchema] = ???
  ...
  def updateNamespace(schema: MetaSchema, db: String, part: String, curNs: String, newNs: String,
                      descr: Option[String] = None, pos0: Int = 0
                     ): Either[String, MetaSchema] = ???
  ...
  def createAttribute(schema: MetaSchema, db: String, part: String, ns: String, attr: String, card: Int, tpe: String,
                      enums: Seq[String] = Nil, optRefNs: Option[String] = None, options: Seq[String] = Nil,
                      doc: Option[String] = None, pos0: Int = 0): Either[String, MetaSchema] = ???

  def updateAttribute(schema: MetaSchema, db: String, part: String, ns: String, curAttr: String, newAttr: String,
                      card: Int,
                      tpe: String,
  ...
  def deleteAttribute(schema: MetaSchema, db: String, part: String, ns: String, attr: String
                     ): Either[String, MetaSchema] = ???
}
